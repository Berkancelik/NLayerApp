...
namespace NLayer.Repository.Migrations
{
    ...
    [Migration("20221029123609_Initial")]
            ...
            modelBuilder.Entity("NLayer.Core.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 10, 29, 15, 36, 9, 387, DateTimeKind.Local).AddTicks(2205),
                            Name = "Kalem 1",
                            Price = 100m,
                            Stock = 25
                        },
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedDate = new DateTime(2022, 10, 29, 15, 36, 9, 387, DateTimeKind.Local).AddTicks(2214),
                            Name = "Kalem 2",
                            Price = 300m,
                            Stock = 25
                        },
                        new
                        {
                            Id = 3,
                            CategoryId = 2,
                            CreatedDate = new DateTime(2022, 10, 29, 15, 36, 9, 387, DateTimeKind.Local).AddTicks(2215),
                            Name = "Kitap 1",
                            Price = 400m,
                            Stock = 35
                        });
